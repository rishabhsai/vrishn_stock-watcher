<script lang="ts">
  ...
  const structuredData = {
    ...
    "description": "Real-time list of today's worst performing stocks with the highest percentage losses, featuring declining stocks and market underperformers.",
    ...
    "about": {
      ...
      "description": "Stocks with highest percentage price decreases and negative market performance"
    }
  };
</script>
