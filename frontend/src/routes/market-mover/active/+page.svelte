<script lang="ts">
  ...
  const structuredData = {
    ...
    "description": "Real-time list of the most actively traded stocks by volume, featuring high-volume securities with significant market activity and trading interest.",
    ...
    "about": {
      ...
      "description": "Stock market securities with highest trading volume and market activity"
    }
  };
</script>
